...
class Settings(BaseSettings):
    APP_TITLE: str = Field("Payments", description="Название приложения")
    APP_DESCRIPTION: str = Field("Асинхронный сервис процессинга платежей", description="Описание приложения")

    API_KEY: str = Field(..., description="API ключ доступа")
